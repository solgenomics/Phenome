...
load_potato_solcap_images.pl

=head1 SYNOPSYS

load_potato_solcap_images.pl -D [ sandbox | cxgn | trial ] -H hostname -i dirname
...
open (ERR, ">load_potato_solcap_images.err") || die "Can't open error file\n";
