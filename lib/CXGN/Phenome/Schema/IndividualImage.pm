...
=head1 TABLE: C<individual_image>
...
=head2 individual_image_id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'individual_image_individual_image_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Lm41pQai24vRFuYSDgBHAw
