...
=head1 NAME
 ...
 0002_remove_genbank_taxon_id.pl
...
no need for genbank_taxon_id column in the organism table anymore.
...
my $patch_name = '0002_remove_genbank_taxon.pl';
my $patch_descr = 'This script removes the genbank_taxon_id column from the public organism table.';
...
ALTER TABLE public.organism DROP COLUMN genbank_taxon_id;
